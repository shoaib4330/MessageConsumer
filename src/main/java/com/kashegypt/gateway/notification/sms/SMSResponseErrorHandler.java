...
@Slf4j
public class SMSResponseErrorHandler implements ResponseErrorHandler {

    private ObjectReader jsonReader = new ObjectMapper().readerFor(SMSResponseMessage.class);
